...
import { getAnalytics, logEvent } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-analytics.js"; // Import getAnalytics and logEvent

// ===== Firebase Config =====
const firebaseConfig = {
  apiKey: "AIzaSyAcPaCL2IhH-xHsuLomL6Srm9umNKZD2XA",
  ...
  measurementId: "G-Y1YVEZY7CN" // Add your Firebase Analytics Measurement ID here
};
...
async function registerWithEmail() {
  ...
  try {
    ...
    // Log the 'sign_up' event in Firebase Analytics
    logEvent(analytics, 'sign_up', {
      method: 'email_link' // You can customize the event name and parameters as needed
    });
  } catch (err) {
    alert(err.message);
  }
